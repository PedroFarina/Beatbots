...
public class Music {
    ...
    public init(name: String) {
        ...
        lanes[MusicPart.Harmony.getIndex()] = [
            ...
            Note(command: .SwipeUp, at: 94 + speed),
            Note(command: .SwipeRight, at: 95.2 + speed),
            Note(command: .SwipeLeft, at: 95.6 + speed),
            Note(command: .SwipeUp, at: 96 + speed),
            Note(command: .SwipeUp, at: 96.6 + speed),
            ...
            Note(command: .SwipeUp, at: 100.4 + speed),
            Note(command: .SwipeRight, at: 101.6 + speed),
            Note(command: .SwipeLeft, at: 102 + speed),
            Note(command: .SwipeUp, at: 102.4 + speed),
            Note(command: .SwipeUp, at: 103 + speed),
            ...
            Note(command: .SwipeUp, at: 106.8 + speed),
            Note(command: .SwipeRight, at: 108 + speed),
            Note(command: .SwipeLeft, at: 108.4 + speed),
            Note(command: .SwipeUp, at: 108.8 + speed),
            Note(command: .SwipeUp, at: 109.4 + speed),
            ...
            Note(command: .SwipeUp, at: 113.2 + speed),
            Note(command: .SwipeRight, at: 114.4 + speed),
            Note(command: .SwipeLeft, at: 114.8 + speed),
            Note(command: .SwipeUp, at: 115.2 + speed),
            Note(command: .SwipeUp, at: 115.8 + speed),
            ...
            Note(command: .SwipeUp, at: 121.6 + speed),
            Note(command: .SwipeUp, at: 122.2 + speed),
            Note(command: .Tap, at: 122.8 + speed),
            Note(command: .SwipeUp, at: 124.8 + speed),
            Note(command: .SwipeUp, at: 125.2 + speed),
            Note(command: .SwipeUp, at: 125.6 + speed),
            Note(command: .SwipeUp, at: 126 + speed),
            Note(command: .SwipeUp, at: 126.4 + speed),
            Note(command: .SwipeUp, at: 126.8 + speed),
            Note(command: .SwipeUp, at: 127.2 + speed),
            Note(command: .SwipeUp, at: 127.6 + speed),
            Note(command: .SwipeRight, at: 128 + speed),
            Note(command: .SwipeRight, at: 128.4 + speed),
            Note(command: .SwipeRight, at: 128.8 + speed),
            Note(command: .SwipeRight, at: 129.2 + speed),
            Note(command: .SwipeRight, at: 129.6 + speed),
            Note(command: .SwipeRight, at: 130 + speed),
            Note(command: .SwipeRight, at: 130.4 + speed),
            Note(command: .SwipeRight, at: 130.8 + speed),
            Note(command: .SwipeRight, at: 131.2 + speed),
            Note(command: .SwipeRight, at: 131.6 + speed),
            Note(command: .SwipeDown, at: 132 + speed),
            Note(command: .SwipeDown, at: 132.4 + speed),
            Note(command: .SwipeDown, at: 132.8 + speed),
            Note(command: .SwipeDown, at: 133.2 + speed),
            Note(command: .SwipeDown, at: 133.6 + speed),
            Note(command: .SwipeDown, at: 134 + speed),
            Note(command: .SwipeLeft, at: 134.4 + speed),
            Note(command: .SwipeLeft, at: 134.8 + speed),
            Note(command: .SwipeLeft, at: 135.2 + speed),
            Note(command: .SwipeLeft, at: 135.6 + speed),
            Note(command: .SwipeLeft, at: 136 + speed),
            Note(command: .SwipeLeft, at: 136.4 + speed),
            ...
            Note(command: .SwipeDown, at: 138.4 + speed),
            Note(command: .SwipeDown, at: 138.8 + speed),
            Note(command: .SwipeDown, at: 139.2 + speed),
            ...
            Note(command: .SwipeRight, at: 147.6 + speed),
            Note(command: .SwipeRight, at: 148 + speed),
            Note(command: .SwipeRight, at: 148.4 + speed),
            Note(command: .SwipeRight, at: 148.8 + speed),
            Note(command: .SwipeRight, at: 149.2 + speed),
            Note(command: .SwipeRight, at: 149.6 + speed),
            Note(command: .SwipeRight, at: 150 + speed),
            Note(command: .SwipeRight, at: 152.8 + speed),
            Note(command: .SwipeLeft, at: 153.2 + speed),
            Note(command: .Tap, at: 153.6 + speed),
            Note(command: .Tap, at: 154.2 + speed),
            Note(command: .SwipeUp, at: 154.8 + speed),
            Note(command: .SwipeRight, at: 156 + speed),
            Note(command: .SwipeLeft, at: 156.4 + speed),
            Note(command: .Tap, at: 156.8 + speed),
            Note(command: .Tap, at: 157.4 + speed),
            Note(command: .SwipeUp, at: 158 + speed),
            Note(command: .SwipeRight, at: 159.2 + speed),
            Note(command: .SwipeLeft, at: 159.6 + speed),
            Note(command: .Tap, at: 160 + speed),
            Note(command: .Tap, at: 160.6 + speed),
            Note(command: .SwipeUp, at: 161.2 + speed),
            Note(command: .SwipeRight, at: 162.4 + speed),
            Note(command: .SwipeLeft, at: 162.8 + speed),
            Note(command: .Tap, at: 163.2 + speed),
            Note(command: .Tap, at: 163.8 + speed),
            Note(command: .SwipeUp, at: 164.4 + speed),
            Note(command: .SwipeRight, at: 165.6 + speed),
            Note(command: .SwipeLeft, at: 166 + speed),
            Note(command: .Tap, at: 166.4 + speed),
            Note(command: .Tap, at: 167 + speed),
            Note(command: .SwipeUp, at: 167.8 + speed),
            Note(command: .SwipeRight, at: 168.8 + speed),
            Note(command: .SwipeLeft, at: 169.2 + speed),
            Note(command: .Tap, at: 169.6 + speed),
            Note(command: .Tap, at: 170.2 + speed),
            Note(command: .SwipeUp, at: 170.8 + speed),
            Note(command: .SwipeRight, at: 172 + speed),
            Note(command: .SwipeLeft, at: 172.4 + speed),
            Note(command: .Tap, at: 172.8 + speed),
            Note(command: .Tap, at: 173.4 + speed),
            Note(command: .SwipeUp, at: 174 + speed),
            Note(command: .SwipeRight, at: 175.2 + speed),
            Note(command: .SwipeLeft, at: 175.6 + speed),
            Note(command: .Tap, at: 176 + speed),
            Note(command: .Tap, at: 176.6 + speed),
            Note(command: .SwipeUp, at: 177.2 + speed),
            Note(command: .SwipeRight, at: 178.4 + speed),
            Note(command: .SwipeLeft, at: 178.8 + speed),
            Note(command: .Tap, at: 179.2 + speed),
            Note(command: .Tap, at: 179.8 + speed),
            Note(command: .SwipeUp, at: 180.4 + speed),
            Note(command: .SwipeRight, at: 181.6 + speed),
            Note(command: .SwipeLeft, at: 182 + speed),
            Note(command: .Tap, at: 182.4 + speed),
            Note(command: .Tap, at: 183 + speed),
            Note(command: .SwipeUp, at: 183.6 + speed)
        ]

        lanes[MusicPart.Melody.getIndex()] = [
            Note(command: .Tap, at: 6+speed),
            Note(command: .SwipeUp, at: 6.4+speed),
            Note(command: .SwipeUp, at: 6.8+speed),
            Note(command: .SwipeDown, at: 7.2+speed),
            Note(command: .SwipeDown, at: 7.6+speed),
            Note(command: .SwipeRight, at: 8+speed),
            Note(command: .SwipeRight, at: 8.4+speed),

            Note(command: .SwipeRight, at: 9.6+speed),
            Note(command: .SwipeRight, at: 10+speed),
            Note(command: .SwipeLeft, at: 10.4+speed),
            Note(command: .SwipeDown, at: 10.8+speed),
            Note(command: .SwipeRight, at: 11.2+speed),
            Note(command: .SwipeRight, at: 11.6+speed),

            Note(command: .SwipeUp, at: 12.8+speed),
            Note(command: .SwipeUp, at: 13.2+speed),
            Note(command: .SwipeDown, at: 13.6+speed),
            Note(command: .SwipeDown, at: 14+speed),
            Note(command: .SwipeRight, at: 14.4+speed),
            Note(command: .SwipeRight, at: 14.8+speed),

            Note(command: .SwipeRight, at: 16+speed),
            Note(command: .SwipeUp, at: 16.4+speed),
            Note(command: .SwipeUp, at: 16.8+speed),
            Note(command: .SwipeLeft, at: 17.2+speed),
            Note(command: .SwipeRight, at: 17.6+speed),

            Note(command: .SwipeUp, at: 19.2+speed),
            Note(command: .SwipeUp, at: 19.6+speed),
            Note(command: .SwipeDown, at: 20+speed),
            Note(command: .SwipeDown, at: 20.4+speed),
            Note(command: .SwipeRight, at: 20.8+speed),
            Note(command: .SwipeRight, at: 21.2+speed),

            Note(command: .SwipeRight, at: 22.4+speed),
            Note(command: .SwipeRight, at: 22.8+speed),
            Note(command: .SwipeLeft, at: 23.2+speed),
            Note(command: .SwipeDown, at: 23.6+speed),
            Note(command: .SwipeRight, at: 24+speed),
            Note(command: .SwipeRight, at: 24.4+speed),
            ...
            Note(command: .SwipeRight, at: 27.2+speed),
            Note(command: .SwipeRight, at: 27.6+speed),

            Note(command: .SwipeRight, at: 28.8+speed),
            Note(command: .SwipeUp, at: 29.2+speed),
            Note(command: .SwipeUp, at: 29.6+speed),
            Note(command: .SwipeLeft, at: 30+speed),
            Note(command: .SwipeRight, at: 30.4+speed),

            Note(command: .Tap, at: 31.5+speed),
            Note(command: .SwipeUp, at: 32+speed),
            Note(command: .SwipeRight, at: 33.2+speed),
            Note(command: .SwipeLeft, at: 33.6+speed),
            Note(command: .SwipeDown, at: 34.3+speed),
            Note(command: .Tap, at: 34.8+speed),
            Note(command: .SwipeDown, at: 35.2+speed),
            Note(command: .SwipeLeft, at: 36.2+speed),
            Note(command: .SwipeRight, at: 36.5+speed),
            Note(command: .Tap, at: 37+speed),

            Note(command: .SwipeUp, at: 38.5+speed),
            Note(command: .SwipeRight, at: 39.6+speed),
            Note(command: .SwipeLeft, at: 39.9+speed),
            Note(command: .SwipeDown, at: 40.5+speed),
            Note(command: .Tap, at: 41+speed),
            Note(command: .SwipeUp, at: 41.3+speed),
            Note(command: .SwipeUp, at: 42+speed),
            Note(command: .SwipeUp, at: 43.5+speed),

            Note(command: .SwipeUp, at: 44.8+speed),
            Note(command: .SwipeRight, at: 46+speed),
            Note(command: .SwipeLeft, at: 46.4+speed),
            Note(command: .SwipeDown, at: 47+speed),
            Note(command: .Tap, at: 47.5+speed),
            Note(command: .SwipeDown, at: 48+speed),
            Note(command: .SwipeLeft, at: 49.1+speed),
            Note(command: .SwipeRight, at: 49.4+speed),
            Note(command: .Tap, at: 49.9+speed),

            Note(command: .SwipeUp, at: 51+speed),
            Note(command: .SwipeRight, at: 52.2+speed),
            Note(command: .SwipeLeft, at: 52.7+speed),
            Note(command: .SwipeDown, at: 53.3+speed),
            Note(command: .Tap, at: 53.7+speed),
            Note(command: .SwipeUp, at: 54.6+speed),
            Note(command: .SwipeUp, at: 56.6+speed),
            Note(command: .SwipeLeft, at: 57.5+speed),
            Note(command: .SwipeRight, at: 58.3+speed),

            Note(command: .Tap, at: 63.6+speed),
            Note(command: .SwipeUp, at: 64+speed),
            Note(command: .SwipeUp, at: 64.4+speed),
            Note(command: .SwipeDown, at: 64.8+speed),
            Note(command: .SwipeDown, at: 65.2+speed),
            Note(command: .SwipeRight, at: 65.6+speed),
            Note(command: .SwipeRight, at: 66+speed),

            Note(command: .SwipeRight, at: 67.2+speed),
            Note(command: .SwipeRight, at: 67.6+speed),
            Note(command: .SwipeLeft, at: 68+speed),
            Note(command: .SwipeDown, at: 68.4+speed),
            Note(command: .SwipeRight, at: 68.8+speed),
            Note(command: .SwipeRight, at: 69.2+speed),

            Note(command: .SwipeUp, at: 70.4+speed),
            Note(command: .SwipeUp, at: 70.8+speed),
            Note(command: .SwipeDown, at: 71.2+speed),
            Note(command: .SwipeDown, at: 71.6+speed),
            Note(command: .SwipeRight, at: 72+speed),
            Note(command: .SwipeRight, at: 72.4+speed),

            Note(command: .SwipeRight, at: 73.6+speed),
            Note(command: .SwipeUp, at: 74+speed),
            Note(command: .SwipeUp, at: 74.4+speed),
            Note(command: .SwipeLeft, at: 74.8+speed),
            Note(command: .SwipeRight, at: 75.2+speed),

            Note(command: .SwipeUp, at: 76.8+speed),
            Note(command: .SwipeUp, at: 77.2+speed),
            Note(command: .SwipeDown, at: 77.6+speed),
            Note(command: .SwipeDown, at: 78+speed),
            Note(command: .SwipeRight, at: 78.4+speed),
            Note(command: .SwipeRight, at: 78.8+speed),

            Note(command: .SwipeRight, at: 80+speed),
            Note(command: .SwipeRight, at: 80.4+speed),
            Note(command: .SwipeLeft, at: 80.8+speed),
            Note(command: .SwipeDown, at: 81.2+speed),
            Note(command: .SwipeRight, at: 81.6+speed),
            Note(command: .SwipeRight, at: 82+speed),

            Note(command: .SwipeUp, at: 83.2+speed),
            Note(command: .SwipeUp, at: 83.6+speed),
            Note(command: .SwipeDown, at: 84+speed),
            Note(command: .SwipeDown, at: 84.4+speed),
            Note(command: .SwipeRight, at: 84.8+speed),
            Note(command: .SwipeRight, at: 85.2+speed),

            Note(command: .SwipeRight, at: 86.4+speed),
            Note(command: .SwipeUp, at: 86.8+speed),
            Note(command: .SwipeUp, at: 87.2+speed),
            Note(command: .SwipeLeft, at: 87.6+speed),
            Note(command: .SwipeRight, at: 88+speed),

            Note(command: .SwipeUp, at: 89.6+speed),
            Note(command: .SwipeUp, at: 90+speed),
            Note(command: .SwipeDown, at: 90.4+speed),
            Note(command: .SwipeDown, at: 90.8+speed),
            Note(command: .SwipeRight, at: 91.2+speed),
            Note(command: .SwipeRight, at: 91.6+speed),

            Note(command: .Tap, at: 92+speed),
            Note(command: .SwipeUp, at: 92.8+speed),
            Note(command: .SwipeRight, at: 94+speed),
            Note(command: .SwipeLeft, at: 94.4+speed),
            Note(command: .SwipeDown, at: 95+speed),
            Note(command: .Tap, at: 95.6+speed),
            Note(command: .SwipeDown, at: 96+speed),
            Note(command: .SwipeLeft, at: 97+speed),
            Note(command: .SwipeRight, at: 97.5+speed),
            Note(command: .Tap, at: 98+speed),

            Note(command: .SwipeUp, at: 99.2+speed),
            Note(command: .SwipeRight, at: 100.3+speed),
            Note(command: .SwipeLeft, at: 100.6+speed),
            Note(command: .SwipeDown, at: 101.2+speed),
            Note(command: .Tap, at: 101.7+speed),
            Note(command: .SwipeUp, at: 102+speed),
            Note(command: .SwipeUp, at: 102.7+speed),
            Note(command: .SwipeUp, at: 104.2+speed),

            Note(command: .SwipeUp, at: 105.5+speed),
            Note(command: .SwipeRight, at: 106.7+speed),
            Note(command: .SwipeLeft, at: 107.1+speed),
            Note(command: .SwipeDown, at: 107.7+speed),
            Note(command: .Tap, at: 108.2+speed),
            Note(command: .SwipeDown, at: 108.7+speed),
            Note(command: .SwipeLeft, at: 109.8+speed),
            Note(command: .SwipeRight, at: 110.1+speed),
            Note(command: .Tap, at: 110.6+speed),

            Note(command: .SwipeUp, at: 111.7+speed),
            Note(command: .SwipeRight, at: 112.9+speed),
            Note(command: .SwipeLeft, at: 113.4+speed),
            Note(command: .SwipeDown, at: 114+speed),
            Note(command: .Tap, at: 114.4+speed),
            Note(command: .SwipeUp, at: 115.3+speed),
            Note(command: .SwipeUp, at: 117.3+speed),
            Note(command: .SwipeLeft, at: 118.2+speed),
            Note(command: .SwipeRight, at: 120+speed),

            Note(command: .Tap, at: 124.4+speed),
            Note(command: .SwipeUp, at: 124.8+speed),
            Note(command: .SwipeUp, at: 125.2+speed),
            Note(command: .SwipeDown, at: 125.6+speed),
            Note(command: .SwipeDown, at: 126+speed),
            Note(command: .SwipeRight, at: 126.4+speed),
            Note(command: .SwipeRight, at: 126.8+speed),

            Note(command: .SwipeRight, at: 128+speed),
            Note(command: .SwipeRight, at: 128.4+speed),
            Note(command: .SwipeLeft, at: 128.8+speed),
            Note(command: .SwipeDown, at: 129.2+speed),
            Note(command: .SwipeRight, at: 129.6+speed),
            Note(command: .SwipeRight, at: 130+speed),

            Note(command: .SwipeUp, at: 131.2+speed),
            Note(command: .SwipeUp, at: 131.6+speed),
            Note(command: .SwipeDown, at: 132+speed),
            Note(command: .SwipeDown, at: 132.4+speed),
            Note(command: .SwipeRight, at: 132.8+speed),
            Note(command: .SwipeRight, at: 133.2+speed),

            Note(command: .SwipeRight, at: 134.4+speed),
            Note(command: .SwipeUp, at: 134.8+speed),
            Note(command: .SwipeUp, at: 135.2+speed),
            Note(command: .SwipeLeft, at: 135.6+speed),
            Note(command: .SwipeRight, at: 136+speed),

            Note(command: .SwipeUp, at: 137.6+speed),
            Note(command: .SwipeUp, at: 138+speed),
            Note(command: .SwipeDown, at: 138.4+speed),
            Note(command: .SwipeDown, at: 138.8+speed),
            Note(command: .SwipeRight, at: 139.2+speed),
            Note(command: .SwipeRight, at: 139.6+speed),

            Note(command: .SwipeRight, at: 140.8+speed),
            Note(command: .SwipeRight, at: 141.2+speed),
            Note(command: .SwipeLeft, at: 141.6+speed),
            Note(command: .SwipeDown, at: 142+speed),
            Note(command: .SwipeRight, at: 142.4+speed),
            Note(command: .SwipeRight, at: 142.8+speed),

            Note(command: .SwipeUp, at: 144+speed),
            Note(command: .SwipeUp, at: 144.4+speed),
            Note(command: .SwipeDown, at: 144.8+speed),
            Note(command: .SwipeDown, at: 145.2+speed),
            Note(command: .SwipeRight, at: 145.6+speed),
            Note(command: .SwipeRight, at: 146+speed),

            Note(command: .SwipeRight, at: 147.2+speed),
            Note(command: .SwipeUp, at: 147.6+speed),
            Note(command: .SwipeUp, at: 148+speed),
            Note(command: .SwipeLeft, at: 148.4+speed),
            Note(command: .SwipeRight, at: 148.8+speed),

            Note(command: .SwipeUp, at: 150.4+speed),
            Note(command: .SwipeUp, at: 150.8+speed),
            Note(command: .SwipeDown, at: 151.2+speed),
            Note(command: .SwipeDown, at: 151.6+speed),
            Note(command: .SwipeRight, at: 152+speed),
            Note(command: .SwipeRight, at: 152.4+speed),

            Note(command: .SwipeUp, at: 153.6+speed),
            Note(command: .SwipeUp, at: 154+speed),
            Note(command: .SwipeDown, at: 154.4+speed),
            Note(command: .SwipeDown, at: 154.8+speed),
            Note(command: .SwipeRight, at: 155.2+speed),
            ...
            Note(command: .SwipeDown, at: 158+speed),
            Note(command: .SwipeRight, at: 158.4+speed),
            Note(command: .SwipeRight, at: 158.8+speed),

            Note(command: .SwipeUp, at: 160+speed),
            Note(command: .SwipeUp, at: 160.4+speed),
            Note(command: .SwipeDown, at: 160.8+speed),
            Note(command: .SwipeDown, at: 161.2+speed),
            Note(command: .SwipeRight, at: 161.6+speed),
            Note(command: .SwipeRight, at: 162+speed),

            Note(command: .SwipeRight, at: 163.2+speed),
            Note(command: .SwipeUp, at: 163.6+speed),
            Note(command: .SwipeUp, at: 164+speed),
            Note(command: .SwipeLeft, at: 164.4+speed),
            Note(command: .SwipeRight, at: 164.8+speed),

            Note(command: .SwipeUp, at: 166.4+speed),
            Note(command: .SwipeUp, at: 166.8+speed),
            Note(command: .SwipeDown, at: 167.2+speed),
            Note(command: .SwipeDown, at: 167.6+speed),
            Note(command: .SwipeRight, at: 168+speed),
            Note(command: .SwipeRight, at: 168.4+speed),

            Note(command: .SwipeRight, at: 169.6+speed),
            Note(command: .SwipeRight, at: 170+speed),
            Note(command: .SwipeLeft, at: 170.4+speed),
            Note(command: .SwipeDown, at: 170.8+speed),
            Note(command: .SwipeRight, at: 171.2+speed),
            Note(command: .SwipeRight, at: 171.6+speed),

            Note(command: .SwipeUp, at: 172.8+speed),
            Note(command: .SwipeUp, at: 173.2+speed),
            Note(command: .SwipeDown, at: 173.6+speed),
            Note(command: .SwipeDown, at: 174+speed),
            Note(command: .SwipeRight, at: 174.4+speed),
            Note(command: .SwipeRight, at: 174.8+speed),

            Note(command: .SwipeRight, at: 176+speed),
            Note(command: .SwipeUp, at: 176.4+speed),
            Note(command: .SwipeUp, at: 176.8+speed),
            Note(command: .SwipeLeft, at: 177.2+speed),
